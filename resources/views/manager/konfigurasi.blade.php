...
@section('content')
        ...
        <div class="grid grid-2 mb-20">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><i class="bi bi-building" style="color:#3b82f6"></i> Informasi & ISP</div>
                </div>
                <div class="card-body">
                    <table style="width:100%">
                        ...
                        <tr>
                            <td style="color:#94a3b8;font-size:0.8rem;padding:7px 0">Perangkat</td>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><i class="bi bi-layers" style="color:#10b981"></i> Konfigurasi VLAN</div>
                </div>
                <div class="card-body">
                    <pre
    ...
    @else
        <div class="card">
            <div class="card-body" style="text-align:center;padding:60px;color:#64748b"><i class="bi bi-gear-wide-connected"
                    style="font-size:3rem;display:block;margin-bottom:12px"></i>Belum ada konfigurasi jaringan. Silakan hubungi
                Admin IT.</div>
        </div>
    @endif
@endsection